...
class NativeParserTest extends TestCase
{
    ...
    #[Test]
    public function invalidXMLWillShutdownBrokenConnection(): void
    {
    ...
    #[Test]
    public function parserGetDataBase64(): void
    {
        $nativeParser = new NativeParser($this->client);
        $this->assertSame('你好，世界', $nativeParser->getData(base64_encode('你好，世界')));
    }
