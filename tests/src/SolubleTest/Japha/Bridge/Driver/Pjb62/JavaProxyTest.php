...
class JavaProxyTest extends TestCase
{
    ...
    #[Test]
    public function getJavaInternalObjectId(): void
    {
        ...
        $this->assertSame('Hello', $javaProxy->__toString());

        $this->assertEquals($string->get__signature(), $javaProxy->get__signature());
        $this->assertSame($string->get__java(), $javaProxy->get__java());
        $this->assertSame($javaProxy->__getJavaInternalObjectId(), $javaProxy->get__java());
    }
}
