...
class AdapterUsageInnerClassTest extends TestCase
{
    ...
    #[Test]
    public function innerClassCalendarBuilder(): void
    {
        $ba = $this->adapter;
        ...
        $this->assertSame('java.util.Calendar$Builder', $ba->getClassName($builder));

        $calendar = $builder->setCalendarType('gregory')->build();

        $this->assertSame('java.util.GregorianCalendar', $ba->getClassName($calendar));
    }
}
