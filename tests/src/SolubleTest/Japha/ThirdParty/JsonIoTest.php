...
class JsonIoTest extends TestCase
{
     ...
     */
    #[Test]
    public function javaSimpleJsonSerialization(): void
    {
        $ba = $this->adapter;
        ...
        $this->assertSame('"Hello world"', (string) $encoded);
    }

    #[Test]
    public function objectJsonSerialization(): void
    {
        $ba = $this->adapter;
        $jsonWriter = $ba->javaClass('com.cedarsoftware.util.io.JsonWriter');
        ...
        $this->assertSame('date', $decoded->javadate->{'@type'});
        $this->assertSame('Java Héllo', $decoded->javastring);
    }

    protected function isJsonIoTestsEnabled(): bool
    {
