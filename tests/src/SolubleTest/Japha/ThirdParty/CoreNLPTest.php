...
class CoreNLPTest extends TestCase
{
    ...
    protected function isCoreNLPTestsEnabled(): bool
    {
    ...
    public function simple(): void
    {
        ...
        $this->assertSame('add your text here!', $results[0]['sentence']);
        $this->assertSame('Hello world.', $results[2]['sentence']);
        $this->assertSame('Hello', $results[2]['words'][0]);
    }
}
